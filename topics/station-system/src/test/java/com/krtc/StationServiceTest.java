...
import com.krtc.model.Station;
import com.krtc.repository.StationRepository;
import com.krtc.service.StationService;
...
class StationServiceTest {
    ...
    @BeforeEach
    void setUp() {
        testStation = new Station("R3", "高雄車站", "紅線");
    ...
    void testGetAllStations() {
        ...
        assertEquals("高雄車站", result.get(0).getName());
